...
//                .append("<input type='").append(type).append("' name='").append(name).append("' displayField='")
//                .append(displayField != null ? displayField : "").append("' placeholder='").append(placeholder).append("'")

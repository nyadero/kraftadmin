...
import com.bowerzlabs.formfields.ImageField;
...
public class ImageFieldStrategy implements FormFieldStrategy {
    @Override
    public boolean supports(Field field, DbObjectSchema dbObjectSchema) {
        if (field.isAnnotationPresent(FormInputType.class)) {
            ...
            return formInputType.value().equals(FormInputType.Type.IMAGE);
        }

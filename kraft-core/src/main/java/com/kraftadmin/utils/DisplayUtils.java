...
import com.kraftadmin.constants.FieldType;
...
public class DisplayUtils {
    ...
    public static FieldValue resolveFieldValue(Object value) {
        ...
        log.info("tika displayField {}", tika.detect(String.valueOf(value)));
...
//    }
    ...
    private static FieldType resolveFieldTypeFromMime(String mime) {
        ...
        if (mime.equals("application/pdf") || mime.contains("word") || mime.contains("document"))
            return FieldType.DOCUMENT;

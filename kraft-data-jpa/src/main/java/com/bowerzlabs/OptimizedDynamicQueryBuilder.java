...
public class OptimizedDynamicQueryBuilder {
    ...
    public static class FieldPath {
        ...
        public FieldPath(String[] pathSegments, Class<?> targetType, boolean isCollection) {
    ...
    public static class QueryResult {
        private final CriteriaQuery<Object> dataQuery;
        private final CriteriaQuery<Long> countQuery;
        private final List<Order> orders;

        public QueryResult(CriteriaQuery<Object> dataQuery, CriteriaQuery<Long> countQuery, List<Order> orders) {
